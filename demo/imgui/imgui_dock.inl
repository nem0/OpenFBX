...
static NewWindow g_new_window = nullptr;
...
struct DockContext
{
	...
	void doUndock(Dock& dock)
	{
		...
		if (!dock.window_handle && g_new_window)
		{
			dock.window_handle = g_new_window(dock.label, 800, 600);
		}
	}
